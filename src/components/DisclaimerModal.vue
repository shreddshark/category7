...
<template>
  ...
  >
    <div
      ref="modalCard"
      class="bg-white dark:bg-slate-900 shadow-soft p-6 md:p-8 border border-slate-200 dark:border-slate-800 rounded-3xl w-full max-w-2xl transition-colors"
    >
      <div class="mb-5">
        <p
          class="mb-2 font-semibold text-blue-600 dark:text-blue-400 text-sm uppercase tracking-[0.2em]"
        >
          Exam Disclaimer
        </p>
        <h2
          class="font-bold text-slate-900 dark:text-white text-2xl md:text-3xl"
        >
      ...
      <div
        class="space-y-4 text-slate-600 dark:text-slate-300 text-sm md:text-base leading-6"
      >
        <p>
        ...
        <p>
          ...
          <span class="font-semibold text-slate-900 dark:text-white">
            I Agree </span
          >, you understand this is an unofficial sample and you want to
